...
const navigation: { label: View; icon: IconName; href: string }[] = [
  { label: "Today", icon: "grid", href: "/" },
  { label: "Inbox", icon: "phone", href: "/inbox/" },
  { label: "Growth", icon: "users", href: "/growth/" },
  { label: "Automations", icon: "workflow", href: "/automations/" },
  { label: "Revenue", icon: "chart", href: "/revenue/" },
  { label: "System", icon: "plug", href: "/system/" },
];
